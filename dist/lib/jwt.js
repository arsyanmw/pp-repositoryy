...
var Jwt = /** @class */ (function () {
    ...
    Jwt.generate = function (identity) {
    ...
    Jwt.generateTemporaryToken = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var signAsync;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Jwt.verify = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        verifyAsync = bluebird_1.promisify(jsonwebtoken_1.verify);
                        return [4 /*yield*/, verifyAsync(token, ACCESS_TOKEN_SECRET)];
                    case 1:
                        decoded = _a.sent();
