...
var BeneficialOwnerClient = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1.default.post(BeneficialOwnerClient.host + path + paramUri_1, body, {
                                headers: headers,
                                timeout: 10000,
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1.default.get(BeneficialOwnerClient.host + path + paramUri_2, { headers: headers, timeout: 10000 })];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        e_2 = _a.sent();
    ...
    BeneficialOwnerClient.host = process.env.BENEFICIAL_OWNER_HOST || 'http://staging-bo.ahu.go.id';
