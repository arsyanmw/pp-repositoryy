...
var BeneficialOwnerClient = /** @class */ (function () {
    ...
    BeneficialOwnerClient.post = function (path, headers, body, params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var paramUri, config, start, endPoint, result, end, e_1, end;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endPoint = BeneficialOwnerClient.host + path + paramUri;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, axios_1.default.post(endPoint, body, config)];
                    case 2:
                        result = _a.sent();
    ...
    BeneficialOwnerClient.get = function (path, headers, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var paramUri_1, config, start, endPoint, result, end, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        start = perf_hooks_1.performance.now();
                        endPoint = BeneficialOwnerClient.host + path + paramUri_1;
                        return [4 /*yield*/, axios_1.default.get(endPoint, config)];
                    case 1:
                        result = _a.sent();
                        end = perf_hooks_1.performance.now();
