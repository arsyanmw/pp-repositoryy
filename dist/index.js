...
var connection = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                connectionOptions = __assign(__assign({}, config), { entities: [__dirname + '/entity/**/*'], logger: config.logger || new winston_1.WinstonAdaptor(new logger_1.Logger().elasticLogger, 'all') });
